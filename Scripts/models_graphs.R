...
capture.output(Summary, file="output_path") # export model summary
write.csv(Coeff_back, "output_path") # export back-transformed coefficients
...
capture.output(Summary2, file="output_path") # export model summary
write.csv(Coeff_back2, "output_path") # export back-transformed coefficients